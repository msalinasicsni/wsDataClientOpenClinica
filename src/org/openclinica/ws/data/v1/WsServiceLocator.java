...
public class WsServiceLocator extends org.apache.axis.client.Service implements org.openclinica.ws.data.v1.WsService {
    ...
    private java.lang.String wsSoap11_address = "http://WIN-C5TEAQ26TGA:8088/ws/dataWsdl";
    ...
    public org.openclinica.ws.data.v1.Ws getwsSoap11() throws javax.xml.rpc.ServiceException {
    ...
    public org.openclinica.ws.data.v1.Ws getwsSoap11(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            org.openclinica.ws.data.v1.WsSoap11Stub _stub = new org.openclinica.ws.data.v1.WsSoap11Stub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (org.openclinica.ws.data.v1.Ws.class.isAssignableFrom(serviceEndpointInterface)) {
                org.openclinica.ws.data.v1.WsSoap11Stub _stub = new org.openclinica.ws.data.v1.WsSoap11Stub(new java.net.URL(wsSoap11_address), this);
                _stub.setPortName(getwsSoap11WSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://openclinica.org/ws/data/v1", "wsService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://openclinica.org/ws/data/v1", "wsSoap11"));
        }
